...
$response = $client->request('GET','http://localhost/uas_rest_api/api/roomdeco',[
  'auth' => ['admin','1234'],
  'query' => [
    'keytoken' => 'key123'
  ]
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link active" href="#">Room Decoration <span class="sr-only">(current)</span></a>
            <a class="nav-link" href="<?= base_url()?>game">PC Gaming Setup</a>
